...
            <div 
              className="flex flex-row justify-start items-center px-[16px] cursor-pointer"
...
                alt="dropdown"
                className={`w-[16px] h-[16px] transition-transform duration-300 ${isProfileMenuOpen ? 'rotate-180' : ''}`}
              />
            </div>

            {/* Profile Menu Items */}
            {isProfileMenuOpen && (
              <div className="flex flex-col gap-[12px] justify-start items-center pb-[16px] mt-[20px] ">
...
                  />
                  <p className="text-[12px] font-inter font-normal leading-[15px] text-left text-[#292D32] ml-[16px]">
                    My Profile
                  </p>
                </div>
